...
// Usamos Nunito como la versión redondeada y geométrica de alta calidad equivalente a Gotham Rounded
val GothamRoundedFontName = GoogleFont("Nunito")

val GothamRounded = FontFamily(
    Font(googleFont = GothamRoundedFontName, fontProvider = provider, weight = FontWeight.Light),
    Font(googleFont = GothamRoundedFontName, fontProvider = provider, weight = FontWeight.Normal),
    Font(googleFont = GothamRoundedFontName, fontProvider = provider, weight = FontWeight.Medium),
